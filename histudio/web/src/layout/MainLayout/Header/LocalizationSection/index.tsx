                                ...
                                {open && (
                                    ...
                                    >
                                        ...
                                        <ListItemButton
                                            ...
                                            onClick={(event) => handleListItemClick(event, 'zh-CN')}
                                        >
                                            <ListItemText
                                                primary={
                                                    <Grid container>
                                                        <Typography color="textPrimary">简体中文</Typography>
                                                        <Typography variant="caption" color="textSecondary" sx={{ ml: '8px' }}>
                                                            (Chinese Simplified)
                                                        </Typography>
                                                    </Grid>
                                        ...
                                        <ListItemButton
                                            ...
                                            onClick={(event) => handleListItemClick(event, 'zh-TW')}
                                        >
                                            <ListItemText
                                                primary={
                                                    <Grid container>
                                                        <Typography color="textPrimary">繁体中文</Typography>
                                                        <Typography variant="caption" color="textSecondary" sx={{ ml: '8px' }}>
                                                            (Chinese Traditional)
                                                        </Typography>
                                                    </Grid>
