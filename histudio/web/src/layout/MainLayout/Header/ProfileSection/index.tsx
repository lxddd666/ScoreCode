    ...
    return (
        <>
            <Chip
                ...
                icon={
                    <Avatar
                        src={user?.avatar ? user?.avatar : User1}
                        alt="user-images"
                        sx={{
                                        ...
                                        <Box sx={{ p: 2, pb: 0 }}>
                                            <Stack>
                                                <Stack direction="row" spacing={0.5} alignItems="center">
                                                    <Typography variant="h3">{user?.realName}</Typography>
                                                </Stack>
                                                ...
                                                >
                                                    <ListItemButton
                                                        ...
                                                        onClick={(event: React.MouseEvent<HTMLDivElement>) =>
                                                            handleListItemClick(event, 0, '/home/account')
                                                        }
                                                    >
                                                        <ListItemIcon>
                                                        ...
                                                        <ListItemText
                                                            primary={
                                                                <Typography variant="body2">
                                                                    <FormattedMessage id="header.accountSetting" />
                                                                </Typography>
                                                            }
                                                        />
                                                    </ListItemButton>
