                    ...
                    <Grid item xs={12}>
                        <CardMediaWrapper>
                            <CardMedia
                                ...
                                title={intl.formatMessage({ id: 'general.under-construction-title' })}
                            />
                            <CardMediaParts src={imageParts} title={intl.formatMessage({ id: 'general.under-construction-title' })} />
                            <CardMediaBuild src={image} title={intl.formatMessage({ id: 'general.under-construction-title' })} />
                        </CardMediaWrapper>
                    </Grid>
                    <Grid item xs={12}>
                        <PageContentWrapper>
                            <Grid container spacing={gridSpacing}>
                                <Grid item xs={12}>
                                    <Typography variant="h1" component="div">
                                        {intl.formatMessage({ id: 'general.under-construction-title' })}
                                    </Typography>
                                </Grid>
                                <Grid item xs={12}>
                                    <Typography variant="body2">
                                        {intl.formatMessage({ id: 'general.under-construction-content' })}
                                    </Typography>
                                </Grid>
                                <Grid item xs={12}>
                                    <AnimateButton>
