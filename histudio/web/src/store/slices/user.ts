...
const slice = createSlice({
    ...
    reducers: {
        ...
        getUserOnlineList(state, action) {
            state.userOnlineList = action.payload;
        },
...
export function getAdminInfo(intl : any) {
    return async () => {
        try {
            const response = await Request({ url: 'admin/member/info', method: 'GET' }, dispatch, intl);
            dispatch(slice.actions.getAdminInfo(response?.data?.data));
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function setAdminInfo(response: any) {
    return async () => {
        dispatch(slice.actions.getAdminInfo(response));
    };
}

export function setAdminInfoError(response: any) {
    return async () => {
...
export function getUserList(queryParam: String) {
    return async () => {
        try {
            const response = await axios.get(`/admin/member/list${queryParam ? '?' + queryParam : ''}`);
...
export function getDeptList(queryParam?: String) {
    return async () => {
        try {
            const response = await axios.get(`/admin/dept/list${queryParam ? '?' + queryParam : ''}`);
            dispatch(slice.actions.getDeptList(response.data));
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function getPostList(queryParam?: String) {
    return async () => {
        try {
            const response = await axios.get(`/admin/post/list${queryParam ? '?' + queryParam : ''}`);
...
export function getUserOnlineList(queryParam?: String) {
    return async () => {
        try {
            const response = await axios.get(`/admin/monitor/userOnlineList${queryParam ? '?' + queryParam : ''}`);
            dispatch(slice.actions.getUserOnlineList(response.data));
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function getMessageList(queryParam?: String) {
    return async () => {
        try {
            const response = await axios.get(`/admin/notice/messageList${queryParam ? '?' + queryParam : ''}`);
            dispatch(slice.actions.getMessageList(response.data));
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
...
export function getRoleList(queryParam?: String) {
    return async () => {
        try {
            const response = await axios.get(`/admin/role/list${queryParam ? '?' + queryParam : ''}`);
            dispatch(slice.actions.getRoleList(response.data));
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
