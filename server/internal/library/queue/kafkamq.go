...
func (r *KafkaMq) ListenReceiveMsgDo(_ context.Context, topic string, receiveDo func(mqMsg MqMsg)) (err error) {
	...
	simple.SafeGo(consumerCtx, func(consumerCtx context.Context) {
		for {
