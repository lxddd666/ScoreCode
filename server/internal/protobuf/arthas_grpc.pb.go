...
const (
	Arthas_Connect_FullMethodName = "/Arthas/connect"
)
...
func (c *arthasClient) Connect(ctx context.Context, in *RequestMessage, opts ...grpc.CallOption) (*ResponseMessage, error) {
	...
	err := c.cc.Invoke(ctx, Arthas_Connect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Arthas_Connect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Arthas_Connect_FullMethodName,
	}
...
const (
	ArthasStream_Connect_FullMethodName = "/ArthasStream/connect"
)
...
func (c *arthasStreamClient) Connect(ctx context.Context, opts ...grpc.CallOption) (ArthasStream_ConnectClient, error) {
	stream, err := c.cc.NewStream(ctx, &ArthasStream_ServiceDesc.Streams[0], ArthasStream_Connect_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
