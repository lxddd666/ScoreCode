...
var file_protobuf_arthas_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x92, 0x0e, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x12, 0x20, 0x01,
	...
	0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0xbb, 0x04, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x74, 0x61, 0x1a, 0x50, 0x0a, 0x12, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x74, 0x61,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x72, 0x65, 0x71, 0x49, 0x64, 0x2a, 0xd2, 0x03, 0x0a, 0x06, 0x41,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x09, 0x0a, 0x05, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x10, 0x00,
	0x12, 0x0a, 0x0a, 0x06, 0x4c, 0x4f, 0x47, 0x4f, 0x55, 0x54, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c,
	...
	0x74, 0x5f, 0x4d, 0x53, 0x47, 0x5f, 0x48, 0x49, 0x53, 0x54, 0x4f, 0x52, 0x59, 0x10, 0x16, 0x2a,
	0x8e, 0x01, 0x0a, 0x0c, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x2a, 0xa7, 0x01, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74,
	...
	0x44, 0x45, 0x10, 0x05, 0x12, 0x13, 0x0a, 0x0f, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x5f, 0x43, 0x4f,
	0x44, 0x45, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x10, 0x06, 0x12, 0x0f, 0x0a, 0x0b, 0x4c, 0x4f, 0x47,
	0x4f, 0x55, 0x54, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x10, 0x07, 0x32, 0x36, 0x0a, 0x06, 0x41, 0x72,
	0x74, 0x68, 0x61, 0x73, 0x12, 0x2c, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12,
	...
	0x67, 0x65, 0x32, 0x40, 0x0a, 0x0c, 0x41, 0x72, 0x74, 0x68, 0x61, 0x73, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x12, 0x30, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x0f, 0x2e,
	...
	0x28, 0x01, 0x30, 0x01, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_protobuf_arthas_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_protobuf_arthas_proto_goTypes = []interface{}{
	...
	(*GetGroupMembersDetail)(nil),    // 46: GetGroupMembersDetail
	(*QueryPreKeyBundleDetail)(nil),  // 47: QueryPreKeyBundleDetail
	(*SyncContactDetail)(nil),        // 48: SyncContactDetail
	(*SetHeadSculptureDetail)(nil),   // 49: SetHeadSculptureDetail
	(*ResponseMessage)(nil),          // 50: ResponseMessage
	(*LoginCallbacks)(nil),           // 51: LoginCallbacks
	(*LoginCallback)(nil),            // 52: LoginCallback
	(*TextMsgCallbacks)(nil),         // 53: TextMsgCallbacks
	(*SendFileAction)(nil),           // 54: SendFileAction
	(*SendContactCardAction)(nil),    // 55: SendContactCardAction
	(*TextMsgCallback)(nil),          // 56: TextMsgCallback
	(*ReadMsgCallbacks)(nil),         // 57: ReadMsgCallbacks
	(*ReadMsgCallback)(nil),          // 58: ReadMsgCallback
	nil,                              // 59: OrdinaryAction.LoginDetailEntry
	nil,                              // 60: LogoutAction.LogoutDetailEntry
	nil,                              // 61: GetUserHeadImageAction.HeadImageEntry
	nil,                              // 62: SyncAccountKeyAction.KeyDataEntry
	nil,                              // 63: SyncAppInfoAction.AppDataEntry
	nil,                              // 64: SendMessageAction.SendDataEntry
	nil,                              // 65: SendMessageAction.SendTgDataEntry
	nil,                              // 66: SendVCardMsgDetailAction.SendDataEntry
	nil,                              // 67: SendGroupMessageAction.SendDataEntry
	nil,                              // 68: SendPhotoAction.SendDataEntry
	nil,                              // 69: sendCodeAction.SendCodeEntry
	nil,                              // 70: ResponseMessage.AccountStatusEntry
	nil,                              // 71: SendFileAction.SendDataEntry
	nil,                              // 72: SendFileAction.SendTgDataEntry
	nil,                              // 73: SendContactCardAction.SendDataEntry
}
var file_protobuf_arthas_proto_depIdxs = []int32{
	59, // 0: OrdinaryAction.login_detail:type_name -> OrdinaryAction.LoginDetailEntry
	60, // 1: LogoutAction.logout_detail:type_name -> LogoutAction.LogoutDetailEntry
	61, // 2: GetUserHeadImageAction.head_image:type_name -> GetUserHeadImageAction.HeadImageEntry
	...
	62, // 6: SyncAccountKeyAction.key_data:type_name -> SyncAccountKeyAction.KeyDataEntry
	63, // 7: SyncAppInfoAction.app_data:type_name -> SyncAppInfoAction.AppDataEntry
	...
	47, // 12: RequestMessage.query_prekeybundle_detail:type_name -> QueryPreKeyBundleDetail
	...
	48, // 17: RequestMessage.sync_contact_detail:type_name -> SyncContactDetail
	...
	46, // 22: RequestMessage.get_group_members_detail:type_name -> GetGroupMembersDetail
	41, // 23: RequestMessage.send_image_file_detail:type_name -> SendImageFileDetail
	42, // 24: RequestMessage.send_contact_card_detail:type_name -> SendContactCardDetail
	32, // 25: RequestMessage.send_group_message_detail:type_name -> SendGroupMessageDetail
	34, // 26: RequestMessage.send_file_detail:type_name -> SendFileDetail
	40, // 27: RequestMessage.send_video_detail:type_name -> SendVideoDetail
	35, // 28: RequestMessage.send_code_detail:type_name -> SendCodeDetail
	36, // 29: RequestMessage.get_contact_list:type_name -> GetContactList
	37, // 30: RequestMessage.get_dialog_list:type_name -> GetDialogList
	38, // 31: RequestMessage.get_msg_history:type_name -> GetMsgHistory
	4,  // 32: RequestMessage.logout_action:type_name -> LogoutAction
	11, // 33: UintSenderVcard.vcards:type_name -> VCard
	64, // 34: SendMessageAction.send_data:type_name -> SendMessageAction.SendDataEntry
	65, // 35: SendMessageAction.send_tgData:type_name -> SendMessageAction.SendTgDataEntry
	66, // 36: SendVCardMsgDetailAction.send_data:type_name -> SendVCardMsgDetailAction.SendDataEntry
	67, // 37: SendGroupMessageAction.send_data:type_name -> SendGroupMessageAction.SendDataEntry
	68, // 38: SendPhotoAction.send_data:type_name -> SendPhotoAction.SendDataEntry
	31, // 39: UintFileDetailValue.value:type_name -> FileDetailValue
	31, // 40: UintTgFileDetailValue.value:type_name -> FileDetailValue
	30, // 41: UintSendContactCard.value:type_name -> ContactCardValue
	25, // 42: SendGroupMessageDetail.details:type_name -> SendGroupMessageAction
	26, // 43: SendPhotoDetail.details:type_name -> SendPhotoAction
	54, // 44: SendFileDetail.details:type_name -> SendFileAction
	39, // 45: SendCodeDetail.details:type_name -> sendCodeAction
	69, // 46: sendCodeAction.send_code:type_name -> sendCodeAction.SendCodeEntry
	54, // 47: SendVideoDetail.details:type_name -> SendFileAction
	54, // 48: SendImageFileDetail.details:type_name -> SendFileAction
	55, // 49: SendContactCardDetail.detail:type_name -> SendContactCardAction
	20, // 50: CreateGroupDetail.detail:type_name -> UintkeyStringvalue
	20, // 51: AddGroupMemberDetail.detail:type_name -> UintkeyStringvalue
	19, // 52: QueryPreKeyBundleDetail.details:type_name -> UintkeyUintvalue
	19, // 53: SyncContactDetail.details:type_name -> UintkeyUintvalue
	10, // 54: SetHeadSculptureDetail.detail:type_name -> SetHeadSculptureAction
	1,  // 55: ResponseMessage.action_result:type_name -> ActionResult
	70, // 56: ResponseMessage.account_status:type_name -> ResponseMessage.AccountStatusEntry
	51, // 57: ResponseMessage.login_callbacks:type_name -> LoginCallbacks
	53, // 58: ResponseMessage.text_msg_callbacks:type_name -> TextMsgCallbacks
	57, // 59: ResponseMessage.read_msg_callbacks:type_name -> ReadMsgCallbacks
	52, // 60: LoginCallbacks.results:type_name -> LoginCallback
	2,  // 61: LoginCallback.loginStatus:type_name -> AccountStatus
	56, // 62: TextMsgCallbacks.results:type_name -> TextMsgCallback
	71, // 63: SendFileAction.send_data:type_name -> SendFileAction.SendDataEntry
	72, // 64: SendFileAction.send_tgData:type_name -> SendFileAction.SendTgDataEntry
	73, // 65: SendContactCardAction.send_data:type_name -> SendContactCardAction.SendDataEntry
	58, // 66: ReadMsgCallbacks.results:type_name -> ReadMsgCallback
	5,  // 67: OrdinaryAction.LoginDetailEntry.value:type_name -> loginDetail
	6,  // 68: LogoutAction.LogoutDetailEntry.value:type_name -> logoutDetail
	8,  // 69: GetUserHeadImageAction.HeadImageEntry.value:type_name -> getUserHeadImage
	15, // 70: SyncAccountKeyAction.KeyDataEntry.value:type_name -> KeyData
	14, // 71: SyncAppInfoAction.AppDataEntry.value:type_name -> appData
	20, // 72: SendMessageAction.SendDataEntry.value:type_name -> UintkeyStringvalue
	21, // 73: SendMessageAction.SendTgDataEntry.value:type_name -> StringKeyStringvalue
	22, // 74: SendVCardMsgDetailAction.SendDataEntry.value:type_name -> UintSenderVcard
	21, // 75: SendGroupMessageAction.SendDataEntry.value:type_name -> StringKeyStringvalue
	20, // 76: SendPhotoAction.SendDataEntry.value:type_name -> UintkeyStringvalue
	2,  // 77: ResponseMessage.AccountStatusEntry.value:type_name -> AccountStatus
	27, // 78: SendFileAction.SendDataEntry.value:type_name -> UintFileDetailValue
	28, // 79: SendFileAction.SendTgDataEntry.value:type_name -> UintTgFileDetailValue
	29, // 80: SendContactCardAction.SendDataEntry.value:type_name -> UintSendContactCard
	18, // 81: Arthas.connect:input_type -> RequestMessage
	18, // 82: ArthasStream.connect:input_type -> RequestMessage
	50, // 83: Arthas.connect:output_type -> ResponseMessage
	50, // 84: ArthasStream.connect:output_type -> ResponseMessage
