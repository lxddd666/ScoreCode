...
// MyOrg 查询我的公司信息
func (s *sSysOrg) MyOrg(ctx context.Context) (res *tgin.SysOrgViewModel, err error) {
	if err = dao.SysOrg.Ctx(ctx).WherePri(contexts.GetUser(ctx).OrgId).Scan(&res); err != nil {
