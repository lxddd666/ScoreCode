      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/tgProxy/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/tgProxy/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
          ...
          <n-button
            ...
            @click="handleExport"
            class="min-left-space"
            v-if="hasPermission(['/tgProxy/export'])"
          >
            <template #icon>
              <n-icon>
                <ExportOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Export, Delete, Status } from '@/api/tg/tgProxy';
  ...
  function handleView(record: Recordable) {
    router.push({ name: 'tgProxyView', params: { id: record.id } });
  }
