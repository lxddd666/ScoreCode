    ...
    <n-spin :show="loading" description="请稍候...">
      ...
      >
        ...
        >
          ...
          <n-form-item label="已连接数" path="connectedCount">
            <n-input-number placeholder="请输入已连接数" v-model:value="params.connectedCount" />
          </n-form-item>

          <n-form-item label="已分配账号数量" path="assignedCount">
            <n-input-number placeholder="请输入已分配账号数量" v-model:value="params.assignedCount" />
          </n-form-item>

          <n-form-item label="长期未登录数量" path="longTermCount">
            <n-input-number placeholder="请输入长期未登录数量" v-model:value="params.longTermCount" />
          </n-form-item>

          <n-form-item label="地区" path="region">
            <n-input type="textarea" placeholder="地区" v-model:value="params.region" />
          </n-form-item>
...
<script lang="ts" setup>
  ...
  import { Edit, View } from '@/api/tg/tgProxy';
