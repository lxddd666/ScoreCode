    ...
    <n-spin :show="loading" description="请稍候...">
      ...
      >
        ...
        >
          ...
          <n-form-item label="操作动作" path="action">
            <n-input-number placeholder="请输入操作动作" v-model:value="params.action" />
          </n-form-item>

          <n-form-item label="账号 id" path="accounts">
          <n-input placeholder="请输入账号 id" v-model:value="params.accounts" />
          </n-form-item>

          <n-form-item label="执行任务参数" path="parameters">
          <n-input placeholder="请输入执行任务参数" v-model:value="params.parameters" />
          </n-form-item>

          <n-form-item label="任务状态,1运行,2停止,3完成,4失败" path="status">
...
<script lang="ts" setup>
  ...
  import { Edit, View } from '@/api/tg/tgBatchExecutionTask';
