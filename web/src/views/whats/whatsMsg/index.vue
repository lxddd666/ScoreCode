      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/whatsMsg/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Export, Delete } from '@/api/whats/whatsMsg';
  ...
  function handleView(record: Recordable) {
    router.push({ name: 'whatsMsgView', params: { id: record.id } });
  }
